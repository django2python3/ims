...
from authentication.models import CUser, Group, Item, Invoice
from authentication.settings import CUSER_SETTINGS

@admin.register(CUser)
class UserAdmin(BaseUserAdmin):
    add_form_template = 'admin/authentication/authentication/add_form.html'
    fieldsets = (
